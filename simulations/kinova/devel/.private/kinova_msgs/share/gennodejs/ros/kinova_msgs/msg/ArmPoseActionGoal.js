...
class ArmPoseActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ArmPoseGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ArmPoseGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArmPoseActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ArmPoseGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ArmPoseGoal()
    }
...
module.exports = ArmPoseActionGoal;
