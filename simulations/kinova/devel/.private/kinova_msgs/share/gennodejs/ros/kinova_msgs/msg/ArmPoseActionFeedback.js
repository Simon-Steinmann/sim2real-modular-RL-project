...
class ArmPoseActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ArmPoseFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ArmPoseActionFeedback
    ...
    bufferOffset = ArmPoseFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ArmPoseActionFeedback
    let len;
    let data = new ArmPoseActionFeedback(null);
    ...
    data.feedback = ArmPoseFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ArmPoseFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArmPoseActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ArmPoseFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ArmPoseFeedback()
    }
...
module.exports = ArmPoseActionFeedback;
