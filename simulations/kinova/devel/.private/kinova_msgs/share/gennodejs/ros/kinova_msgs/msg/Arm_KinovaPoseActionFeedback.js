...
class Arm_KinovaPoseActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new Arm_KinovaPoseFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type Arm_KinovaPoseActionFeedback
    ...
    bufferOffset = Arm_KinovaPoseFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type Arm_KinovaPoseActionFeedback
    let len;
    let data = new Arm_KinovaPoseActionFeedback(null);
    ...
    data.feedback = Arm_KinovaPoseFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Arm_KinovaPoseActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = Arm_KinovaPoseFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new Arm_KinovaPoseFeedback()
    }
...
module.exports = Arm_KinovaPoseActionFeedback;
