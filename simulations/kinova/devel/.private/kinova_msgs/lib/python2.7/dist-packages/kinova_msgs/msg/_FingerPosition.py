...
float32 finger3
"""
  __slots__ = ['finger1','finger2','finger3']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3f().pack(_x.finger1, _x.finger2, _x.finger3))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.finger1, _x.finger2, _x.finger3,) = _get_struct_3f().unpack(str[start:end])
      return self
