...
class PlanningOptions(genpy.Message):
  _md5sum = "9ce85f6618d683464c5f8dec823e30a7"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_B().pack(self.planning_scene_diff.robot_state.is_diff))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.planning_scene_diff.world.octomap.octomap.binary))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_d().pack(self.planning_scene_diff.world.octomap.octomap.resolution))
