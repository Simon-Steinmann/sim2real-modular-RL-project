...
class PickupGoal(genpy.Message):
  _md5sum = "8098ddaa236be12a7d427b70bf25b68a"
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.allow_gripper_support_collision))
      ...
      buff.write(_get_struct_B().pack(self.minimize_object_distance))
      ...
      for val1 in self.allowed_touch_objects:
        ...
        if python3 or type(val1) == unicode:
          ...
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      buff.write(_get_struct_d().pack(self.allowed_planning_time))
