...
class PlanningScene(genpy.Message):
  _md5sum = "42f2f7d3472c741e60498f4d859fe06f"
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.world.octomap.octomap.binary))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_d().pack(self.world.octomap.octomap.resolution))
      length = len(self.world.octomap.octomap.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(struct.pack(pattern, *self.world.octomap.octomap.data))
      buff.write(_get_struct_B().pack(self.is_diff))
