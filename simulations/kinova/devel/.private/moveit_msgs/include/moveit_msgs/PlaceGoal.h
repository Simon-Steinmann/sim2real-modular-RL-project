...
struct MD5Sum< ::moveit_msgs::PlaceGoal_<ContainerAllocator> >
{
  ...
  {
    return "8efecac01d1de18276ab53cb5778f445";
  }

  static const char* value(const ::moveit_msgs::PlaceGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8efecac01d1de182ULL;
  static const uint64_t static_value2 = 0x76ab53cb5778f445ULL;
};
