...
struct MD5Sum< ::moveit_msgs::PlanningScene_<ContainerAllocator> >
{
  ...
  {
    return "42f2f7d3472c741e60498f4d859fe06f";
  }

  static const char* value(const ::moveit_msgs::PlanningScene_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x42f2f7d3472c741eULL;
  static const uint64_t static_value2 = 0x60498f4d859fe06fULL;
};
