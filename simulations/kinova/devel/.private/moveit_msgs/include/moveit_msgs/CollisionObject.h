...
struct MD5Sum< ::moveit_msgs::CollisionObject_<ContainerAllocator> >
{
  ...
  {
    return "f5dff86df1238076802d21d63471714d";
  }

  static const char* value(const ::moveit_msgs::CollisionObject_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf5dff86df1238076ULL;
  static const uint64_t static_value2 = 0x802d21d63471714dULL;
};
