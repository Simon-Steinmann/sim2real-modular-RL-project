...
struct MD5Sum< ::moveit_msgs::PlaceAction_<ContainerAllocator> >
{
  ...
  {
    return "c2341bfed3a78f2e067c4ac3d53f9541";
  }

  static const char* value(const ::moveit_msgs::PlaceAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc2341bfed3a78f2eULL;
  static const uint64_t static_value2 = 0x067c4ac3d53f9541ULL;
};
