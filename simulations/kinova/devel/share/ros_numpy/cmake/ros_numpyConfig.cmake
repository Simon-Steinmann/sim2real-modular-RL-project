...
if("TRUE" STREQUAL "TRUE")
  set(ros_numpy_SOURCE_PREFIX /home/simon/sim2real/simulations/kinova/src/ros_numpy)
  set(ros_numpy_DEVEL_PREFIX /home/simon/sim2real/simulations/kinova/devel)
  ...
  set(ros_numpy_INSTALL_PREFIX /home/simon/sim2real/simulations/kinova/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/ros_numpy " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Eric Wieser <wieser@mit.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ros_numpy' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simon/sim2real/simulations/kinova/src/ros_numpy/${idir}'.  ${_report}")
    endif()
