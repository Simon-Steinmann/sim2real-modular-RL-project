...
for robot_name in robots:
  ...
  for i in range(1,fingers+1):  
    ...
    finger_tip_joints.append(robot_name + '_joint_finger_tip_' + str(i))
  ...
  #add finger tip joint position controllers 
  i = 0
  for joint in finger_tip_joints:  
    finger_tip_joint_position_controller =  { 'finger_tip_' + str(i+1) + '_position_controller':
										                       {
										                       'type':'effort_controllers/JointPositionController',
										                       'joint':joint,
										                       'pid': {'p': 0.5, 'i': 0, 'd': 0}
    ...
    i = i + 1
    robot_controllers.update(finger_tip_joint_position_controller)    
