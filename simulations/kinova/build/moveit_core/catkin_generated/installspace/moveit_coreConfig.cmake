...
if(NOT "include;/usr/include;/usr/include/eigen3;/opt/ros/melodic/include " STREQUAL " ")
  set(moveit_core_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include;/usr/include/eigen3;/opt/ros/melodic/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/acis/sim2real/simulations/kinova/install/${idir}'.  ${_report}")
    endif()
