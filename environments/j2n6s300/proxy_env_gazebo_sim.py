...
environment_id = 'j2n6s300Test-v4'
action_space = gym.spaces.Discrete(12)
observation_space = gym.spaces.Box(-numpy.full((24),2) , numpy.full((24),2) )
entry_point='environments.j2n6s300.proxy_env_gazebo_sim:ProxyGymEnv'
# -----------------------------------------------
