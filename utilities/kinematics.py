...
class Jaco2Kinematics(object):
    def __init__(self):
        ...
        self.chain1 = ikpy.chain.Chain(
            ...
            name='j2n6s300')
        self.chain2 = ikpy.chain.Chain.from_urdf_file( '/home/simon/sim2real/simulations/kinova/src/ml_using_tf/urdf/j2n6s300.xarco', 
        ["root"])
        print("----------")
        print(self.chain1)
        pos = [0.0, 2.9, 1.3, -2.07, 1.4, 0.0, 0]
        print(self.chain1.forward_kinematics(pos,True))
